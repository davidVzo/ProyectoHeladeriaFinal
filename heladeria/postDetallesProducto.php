...
if ($_SERVER['REQUEST_METHOD'] == 'GET')
{
    ...
    {
      //Mostrar un post
      $sql = $dbConn->prepare("SELECT * FROM detalleventas INNER JOIN productos ON detalleventas.Productos_idProductos = productos.idProductos  WHERE Ventas_idVentas=:Ventas_idVentas");
