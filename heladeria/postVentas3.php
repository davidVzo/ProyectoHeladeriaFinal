...
{
      if(isset($_GET['Usuario_idUsuario']) and isset($_GET['numeroVenta'])) {
           //Mostrar un post
      $sql = $dbConn->prepare("SELECT * FROM ventas  where Usuario_idUsuario=:Usuario_idUsuario and numeroVenta=:numeroVenta  ");
      $sql->bindValue(':Usuario_idUsuario', $_GET['Usuario_idUsuario']);
      $sql->bindValue(':numeroVenta', $_GET['numeroVenta']);
      $sql->execute();
